...
//
// ⚠️ ค่าต่ำสุดที่ใช้ได้จริงถูกกำหนดโดยเครื่องพิมพ์ ไม่ใช่โค้ด
//   หัวพิมพ์เข้าไม่ถึงริมกระดาษ กินไปข้างละ ~3-4mm (ด้านล่างบางรุ่นกินมากกว่านั้น)
//   เคยลองตั้งซ้าย-ขวา = 0 แล้ว → ริมตารางโดนตัด จึงกลับมาที่ 4mm
//   ถ้ายังโดนตัดอีก เพิ่มค่าตรงนี้ที่เดียวจบ (ทั้งพิมพ์จาก PC และแท็บเล็ต)
const PAGE_MARGIN = "4mm";      // ซ้าย-ขวา (ข้างละ)
const PAD_TOP = "4mm";
const PAD_BOTTOM = "4mm";
...
//   มีที่ว่างเหลือเฟือ (คอลัมน์ตายตัวรวม ~502px จากพื้นที่พิมพ์ ~764px)

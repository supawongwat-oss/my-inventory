...
export const LIMITS = {
  ...
  // 🛡️ เพดานของบิล — ที่ร้านเขียนบิล+ใบสั่งด้วยมือรวมกัน 2,500 ใบ/เดือน
  // ถ้าคีย์เข้าระบบครบ หน้าต่าง 30 วันจะเก็บได้ราวหนึ่งเดือนเต็ม = ชนเพดาน 3,000 พอดี
  // ชนเมื่อไรบิลเก่าหลุดเงียบ ๆ แล้วใบวางบิลยอดขาด = เก็บเงินลูกค้าไม่ครบ
  // ขยายเป็น 10,000 เพื่อกันไว้ก่อน (เรื่องน้ำหนักการโหลดแก้ที่การให้แต่ละหน้าดึงของตัวเอง)
  invoicesCap: 10000,
...
const DEFAULT_DAYS = {
  ...
  // บิล — เดิม 30 วันเพราะรายงาน/วางบิล/ประวัติลูกค้าอาศัยกองนี้ทั้งหมด
  // ตอนนี้หน้าพวกนั้นไปขอข้อมูลของตัวเองแล้ว (utils/fetchInvoices.js)
  // กองนี้จึงเหลือหน้าที่แค่งานประจำวัน = ออกบิล/แก้บิล/ดูรายการล่าสุด
  // ที่ 2,500 ใบ/เดือน 30 วันคือแบก ~27 MB ทุกครั้งที่เปิดแอป ทั้งที่ใช้จริงไม่กี่วัน
  // กดขยายเองได้ที่แถบช่วงวันที่ในหน้าออกบิล ถ้าต้องย้อนดูไกลกว่านี้
  invoices: 7,
